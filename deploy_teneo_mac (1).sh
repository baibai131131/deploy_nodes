#!/bin/bash
# Teneo Beacon Mac installer v1.0.1 -- M1/M2/M3/M4.
# Fixed, checksum-verified official release. No Clash/proxy/route changes.
# Limit locale to this process and its children; never change macOS preferences.
export LC_ALL=C
set -Eeuo pipefail
umask 077
...
info "Teneo Mac 安装器 v1.0.1；官方固定版本 ${release}。"
